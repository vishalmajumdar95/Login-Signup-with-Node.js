import { PendingOperation } from 'tarn/lib/PendingOperation';
...
export declare class Pool<T> {
    ...
    isEmpty(): boolean;
    check(): void;
    destroy(): Promise<import("tarn/lib/PromiseInspection").PromiseInspection<{}> | import("tarn/lib/PromiseInspection").PromiseInspection<void>>;
